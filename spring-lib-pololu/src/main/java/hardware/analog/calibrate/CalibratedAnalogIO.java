 ...
 */
package hardware.analog.calibrate;

import hardware.analog.AnalogIO;
import hardware.util.Delegator;
import hardware.util.sguava.Converter;

import java.util.function.Function;

import static hardware.util.math.InterRangeDoubleConverter.IDENTITY_FUNCTION;
