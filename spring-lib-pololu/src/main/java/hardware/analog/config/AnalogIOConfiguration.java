 ...
 */
package hardware.analog.config;

import hardware.analog.AnalogIO;
import hardware.analog.AnalogIOController;
import hardware.analog.AnalogIOSource;
import hardware.analog.calibrate.AnalogIOSourceCalibrator;

import java.util.function.Function;

import static hardware.analog.AnalogIOSources.*;
