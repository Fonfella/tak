 ...
 */
package hardware.util.math;

import hardware.util.sguava.Converter;

import java.util.function.Function;

import static hardware.util.math.DoubleRange.*;

/**
 * Converts Double objects linearly according to two corresponding {Range} objects.
 *
...
public class InterRangeDoubleConverter extends Converter<Double, Double>
{
    ...
    public static final Function<Double, Double> IDENTITY_FUNCTION = Function.identity();
