...
import com.fonfella.tape.codec.TapeCodec;
import com.fonfella.tape.factory.EventFactory;
import com.fonfella.tape.model.Event;
import com.fonfella.tape.model.RawEvent;
import com.fonfella.tape.model.RawEvent.RawEventBuilder;
...
public class TapeDeck extends AbstractService {
    ...
    public Future<Tape> record(StartRecord startRecord) throws IOException {
        ...
        List<ExecResult.Line> events = tapeRecorder.record(startRecord);
    ...
    private List<RawEvent> elapsed(List<ExecResult.Line> events) {
        ...
        for (ExecResult.Line event : events) {
